...
public class MainForm extends JFrame implements TreeSelectionListener {
	...
	protected void buildGUI() {
		...
		searchPanel.add(searchF);
		String items[] = { "By last name", "By name", "By father name",
				  "By tabel number", "By birthday"};
	...
	public void addListeners() {
		...
		searchNextBtn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				case "By name":
					entry = new EmployeeAdapter("", searchF.getText(), "",
							 "", "", "");
					break;
				...
				case "By birthday":
					...
					entry = new EmployeeAdapter("", "", "", "", searchF
							.getText(), "");
					break;
	...
	public void valueChanged(TreeSelectionEvent event) {
		...
		if (selectedNode != null
			...
			if (curView != null)
				panel.remove(curView);
			curView = ((EmployeeAdapter) selectedNode.getUserObject())
					.getView();
			panel.add(curView);
			this.revalidate();
		} else {
